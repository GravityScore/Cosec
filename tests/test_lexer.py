...
from lexer import Tokens, Token, IntSuffix, FloatSuffix


class TestWhitespace(TestCase):
    def test_empty_file(self):
        t = Tokens("", "")
        self.assertEqual(t.cur().type, Token.EOF)
    ...
    def test_one_token(self):
        t = Tokens("", "+")
        self.assertEqual(t.cur().type, Token.ADD)
        t.next()
        self.assertEqual(t.cur().type, Token.EOF)
    ...
    def test_two_tokens(self):
        ...
        self.assertEqual(t.cur().type, Token.ADD)
        t.next()
        self.assertEqual(t.cur().type, Token.COMMA)
        t.next()
        self.assertEqual(t.cur().type, Token.EOF)
...
class TestSyntaxTokens(TestCase):
    def test_one_character_tokens(self):
        ...
        self.assertEqual(t.cur().type, Token.ADD)
        t.next()
        self.assertEqual(t.cur().type, Token.GT)
        t.next()
        self.assertEqual(t.cur().type, Token.GT)
        t.next()
        self.assertEqual(t.cur().type, Token.ASSIGN)
        t.next()
        self.assertEqual(t.cur().type, Token.LOGICAL_NOT)
        t.next()
        self.assertEqual(t.cur().type, Token.ASSIGN)
        t.next()
        self.assertEqual(t.cur().type, Token.EOF)
    ...
    def test_two_character_tokens(self):
        t = Tokens("", "++ >> = !=")
        self.assertEqual(t.cur().type, Token.INC)
        t.next()
        self.assertEqual(t.cur().type, Token.RSHIFT)
        t.next()
        self.assertEqual(t.cur().type, Token.ASSIGN)
        t.next()
        self.assertEqual(t.cur().type, Token.NEQ)
        t.next()
        self.assertEqual(t.cur().type, Token.EOF)
    ...
    def test_three_character_tokens(self):
        ...
        self.assertEqual(t.cur().type, Token.GT)
        t.next()
        self.assertEqual(t.cur().type, Token.RSHIFT_ASSIGN)
        t.next()
        self.assertEqual(t.cur().type, Token.NEQ)
        t.next()
        self.assertEqual(t.cur().type, Token.DOT)
        t.next()
        self.assertEqual(t.cur().type, Token.ELLIPSIS)
        t.next()
        self.assertEqual(t.cur().type, Token.EOF)
...
class TestIdentifiers(TestCase):
    def test_one_character_identifier(self):
        t = Tokens("", "a")
        self.assertEqual(t.cur().type, Token.IDENT)
...
class TestKeywords(TestCase):
    def test_common_keywords(self):
        ...
        self.assertEqual(t.cur().type, Token.FOR)
        t.next()
        self.assertEqual(t.cur().type, Token.IF)
        t.next()
        self.assertEqual(t.cur().type, Token.WHILE)
        t.next()
        self.assertEqual(t.cur().type, Token.EOF)
...
class TestIntegers(TestCase):
    def test_decimal(self):
        ...
        self.assertEqual(t.cur().type, Token.CONST_INT)
...
class TestFloats(TestCase):
    def test_decimal(self):
        ...
        self.assertEqual(t.cur().type, Token.CONST_FLOAT)
