...
from lexer import Tokens, TokenType, IntSuffix, FloatSuffix


class TestWhitespace(TestCase):
    def test_empty_file(self):
        t = Tokens("", "")
        self.assertEqual(t.cur().type, TokenType.EOF)
    ...
    def test_one_token(self):
        t = Tokens("", "+")
        self.assertEqual(t.cur().type, TokenType.ADD)
        t.next()
        self.assertEqual(t.cur().type, TokenType.EOF)
    ...
    def test_two_tokens(self):
        ...
        self.assertEqual(t.cur().type, TokenType.ADD)
        t.next()
        self.assertEqual(t.cur().type, TokenType.COMMA)
        t.next()
        self.assertEqual(t.cur().type, TokenType.EOF)
...
class TestSyntaxTokens(TestCase):
    def test_one_character_tokens(self):
        ...
        self.assertEqual(t.cur().type, TokenType.ADD)
        t.next()
        self.assertEqual(t.cur().type, TokenType.GT)
        t.next()
        self.assertEqual(t.cur().type, TokenType.GT)
        t.next()
        self.assertEqual(t.cur().type, TokenType.ASSIGN)
        t.next()
        self.assertEqual(t.cur().type, TokenType.LOGICAL_NOT)
        t.next()
        self.assertEqual(t.cur().type, TokenType.ASSIGN)
        t.next()
        self.assertEqual(t.cur().type, TokenType.EOF)
    ...
    def test_two_character_tokens(self):
        t = Tokens("", "++ >> = !=")
        self.assertEqual(t.cur().type, TokenType.INC)
        t.next()
        self.assertEqual(t.cur().type, TokenType.RSHIFT)
        t.next()
        self.assertEqual(t.cur().type, TokenType.ASSIGN)
        t.next()
        self.assertEqual(t.cur().type, TokenType.NEQ)
        t.next()
        self.assertEqual(t.cur().type, TokenType.EOF)
    ...
    def test_three_character_tokens(self):
        ...
        self.assertEqual(t.cur().type, TokenType.GT)
        t.next()
        self.assertEqual(t.cur().type, TokenType.RSHIFT_ASSIGN)
        t.next()
        self.assertEqual(t.cur().type, TokenType.NEQ)
        t.next()
        self.assertEqual(t.cur().type, TokenType.DOT)
        t.next()
        self.assertEqual(t.cur().type, TokenType.ELLIPSIS)
        t.next()
        self.assertEqual(t.cur().type, TokenType.EOF)
...
class TestIdentifiers(TestCase):
    def test_one_character_identifier(self):
        t = Tokens("", "a")
        self.assertEqual(t.cur().type, TokenType.IDENT)
...
class TestKeywords(TestCase):
    def test_common_keywords(self):
        ...
        self.assertEqual(t.cur().type, TokenType.FOR)
        t.next()
        self.assertEqual(t.cur().type, TokenType.IF)
        t.next()
        self.assertEqual(t.cur().type, TokenType.WHILE)
        t.next()
        self.assertEqual(t.cur().type, TokenType.EOF)
...
class TestIntegers(TestCase):
    def test_decimal(self):
        ...
        self.assertEqual(t.cur().type, TokenType.CONST_INT)
    ...
    def test_suffixes(self):
        ...
        self.assertEqual(t.cur().type, TokenType.CONST_INT)
        self.assertEqual(t.cur().number, 1)
        self.assertEqual(t.cur().suffix, IntSuffix.UNSIGNED)
        t.next()
        self.assertEqual(t.cur().type, TokenType.CONST_INT)
        self.assertEqual(t.cur().number, 1)
        self.assertEqual(t.cur().suffix, IntSuffix.UNSIGNED)
        ...
        self.assertEqual(t.cur().type, TokenType.CONST_INT)
        self.assertEqual(t.cur().number, 1)
        self.assertEqual(t.cur().suffix, IntSuffix.UNSIGNED_LONG)
        t.next()
        self.assertEqual(t.cur().type, TokenType.CONST_INT)
        self.assertEqual(t.cur().number, 1)
        self.assertEqual(t.cur().suffix, IntSuffix.UNSIGNED_LONG)
        ...
        self.assertEqual(t.cur().type, TokenType.CONST_INT)
        self.assertEqual(t.cur().number, 1)
        self.assertEqual(t.cur().suffix, IntSuffix.UNSIGNED_LLONG)
        t.next()
        self.assertEqual(t.cur().type, TokenType.CONST_INT)
...
class TestFloats(TestCase):
    def test_decimal(self):
        ...
        self.assertEqual(t.cur().type, TokenType.CONST_FLOAT)
    ...
    def test_decimal_suffixes(self):
        ...
        self.assertEqual(t.cur().type, TokenType.CONST_FLOAT)
        self.assertEqual(t.cur().number, 1.0)
        self.assertEqual(t.cur().suffix, FloatSuffix.LONG_DOUBLE)
        t.next()
        self.assertEqual(t.cur().type, TokenType.CONST_FLOAT)
        self.assertEqual(t.cur().number, 1.0)
        self.assertEqual(t.cur().suffix, FloatSuffix.LONG_DOUBLE)
